...
return (
        <div className={`min-h-screen ${bg} p-4 md:p-10 ${text} transition-colors duration-300 md:ml-16 w-full md:w-[calc(100%-4rem)]`}>
            ...
            <div className="max-w-7xl mx-auto">
                {/* Header */}
                <header className={`flex items-center pb-6 mb-6 border-b ${border} md:fixed md:${bg} md:w-full`}>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start md:mt-40">
